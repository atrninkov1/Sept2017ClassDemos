    ...
    <div class="row">
        <div class="col-md-12">
                            ...
                            <asp:ListView ID="ListViewCRUD"
                                    ...
                                    <tr style="border: double">
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ArtistIDDropdownList" runat="server"
                                                DataSourceID="ArtistListODS" DataTextField="Name" DataValueField="ArtistId" SelectedValue='<%# Eval("ArtistId") %>' Enabled="false">
                                            </asp:DropDownList>
                                ...
                                <EditItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ArtistIDDropdownList" runat="server"
                                                DataSourceID="ArtistListODS" DataTextField="Name" DataValueField="ArtistId" SelectedValue='<%# Bind("ArtistId") %>'>
                                            </asp:DropDownList>
                                        <td>
            ...
            <%--some people will collect all ODS controls and place them in a single location for easy access. 
                The ODS controls are not associated with a specific tab but instead the entire page.--%>
        </div>
